  ...
  const dispatch = useDispatch();
    ...
    if(connections.length === 0) return (
      <div className="flex-1 min-h-screen bg-gray-950 flex flex-col items-center justify-center pb-20">
        <h1 className="text-2xl text-gray-400">No Connections Yet</h1>
 ...
 return (
   <div className='flex-1 min-h-screen bg-gray-950 py-10 px-4 pb-20'>
       <div className="max-w-2xl mx-auto">
         <h1 className='text-white text-3xl font-bold text-center'>Your Connections</h1>
         <p className='text-yellow-500 text-center text-sm mt-2 mb-8'>You have {connections.length} connection{connections.length !== 1 ? 's' : ''}</p>
            ...
            return (
              <div key={_id} className='flex items-center gap-4 p-4 rounded-xl bg-gray-900 border border-gray-800 hover:border-gray-700 transition-colors'>
                ...
                <div className='flex-1 min-w-0'>
                  ...
                  {About && <p className='text-yellow-500 text-sm mt-1 line-clamp-1'>{About}</p>}
